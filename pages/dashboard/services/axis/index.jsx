...
import { Box, Button, Stack, HStack, useToast, Text } from "@chakra-ui/react";
  ...
  return (
    <>
      <DashboardWrapper pageTitle={"Axis Bank Account"}>
        <Box rounded={12} bg={"#FFF"} boxShadow={"lg"} p={4}>
          <Text>Apply For New Bank Account</Text>
          <Stack gap={8} w={"full"} p={4} direction={["column", "row"]}>
            <Button
            ...
            >
              Current Account for Proprietorship
            </Button>
          </Stack>

          <HStack justifyContent={"flex-end"} p={4}>
            <Button colorScheme="twitter" onClick={applyNow}>
              Apply Now
            </Button>
          </HStack>
        </Box>
